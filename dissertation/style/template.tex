...
$if(endfloat)$
    ...
    \DeclareDelayedFloatFlavour*{longtable}{table}\usepackage{amssymb,amsmath}
$endif$
...
\def\titlepage{
    ...
    \begin{center}
        ...
        {\mbox{\large{$if(subtitle)$$subtitle$$endif$}}} \\
        \vskip 18pt
        by \\ [8pt]
...
% Commented so that order of source files in dissertation folder determines order
  % $if(toc)$
  %   {
  %     $if(colorlinks)$
