...
The seating arrangement creates a distinct left and right side of the ensemble that mirror one another. For Groups III and IV, this mirroring is even reflected in the order of the instruments within the group. The outer seats contain a wind-powered instrument, the middle seats a string, and the inner seats an attack-based instrument. The arrangement is intimately connected to the way Abrahamsen handles orchestration and transfers musical material between groups. He does this in a way that is generally balanced and symmetrical wherein phrases performed by one group of instruments are answered by phrases from a corresponding mirror group. For instance, in the second sections of Part I, the middle circle's marimba (Group III) and harp (Group IV) exchange percussive, chromatic lines while their inner circle counterparts (Group I for the marimba, Group II for the harp) sustain the pitches of their attacks. The relationship between orchestration and seating arrangement is not always active or perfectly symmetrical but nonetheless shapes a significant part of *Wald*.
...
Part I consists of the Introduction, Variation 1, and Variation 2, and it takes up almost half of *Wald*'s duration. It establishes the principle compositional techniques and associative sets through these three sequences of four sections. The four sections differ in tempo, harmony, density of activity, and number of active associative sets. As in the relationship between *Walden*'s first and second movements, the four sections group into pairs where the second and fourth sections recontextualize the same associative sets from the first and third sections, respectively. Similarly, each variation within Part I re-reads the previous variation's four sections. Part II, containing Variations 3 and 4, contrasts with the first part through its quiet, introverted stasis and lack of sectional subdivisions. The two variations are bound together not only by slow tempo but also by the mysterious and winding low melody scored for cello, double bass, and timpani. Part III only includes Variation 5 but it functions as the climax, with the loudest, most chaotic, and texturally dense music. It divides into three sections; the first suddenly breaks the pensive atmosphere of Part II, while the second and third consist of a build up in energy through galloping rhythms. Finally, the last two variations of Part IV combine varied material from the third sections of Part I along with literal repetitions of segments from the fourth sections of Part I.

<!-- refer to form table earlier for clarity -->

Like *Walden* and *Schnee*, which Abrahamsen also identifies as a "twin piece,"[@WaldPN Program Note] the eight sections of *Wald* decrease in duration over the course of the work. The compression of proportions at the variation-level is obscured somewhat both by the variations containing subdivisions and by the related variations forming parts. For instance, the section divisions within the variations of Part I encourage a more granular listening experience that makes perceiving the long-range compression difficult at first. These sections follow a particular ordering from longest to shortest (section 3, 2, 1, and 4), and also mirror the variation-level compression by decreasing in duration from variation to variation. But rather than pointing to any sort of deficiency in Abrahamsen's form, this multi-level proportion structure instead allows one to engage with *Wald* on the subdivision-, variation-, or part-level.

Abrahamsen juxtaposes the various subdivisions, variations, and parts with little to no transitional material. Their boundaries are clearly demarcated both sonically by abrupt changes in dynamics, timbre, texture, and register as well as visually in the score by different tempi, meters, descriptive markings, and double bar lines. Abrahamsen facilitates these abrupt juxtapositions through the use of metric modulations, which is a common characteristic of his third period. Table @tbl:wald-form details the divisions within *Wald* by providing a comprehensive list of every tempo change and descriptive marking that accompanies a variation or subdivision. Table @tbl:wald-form also identifies the variations that group together as Parts (evident through explicitly returning tempo and descriptive markings) and gives the durations for individual variations (measured from the only commercially released recording by Asko|Schönberg Ensemble[@WaldRec]).
