...
The horn has a special significance for Abrahamsen musically and personally. He was born with cerebral palsy which affects the right side of his body.[@NYT] He walks with an uneven gait and has only two functional fingers on his right hand leaving him unable to pursue most instruments to professional proficiency.[@NYT] Since the French horn can be played with only the left hand, it became his principle instrument early on and inspired some of his first compositions. The first ever performance of his own music took place in 1969 with a piece called *October*, for horn and piano. Abrahamsen performed both instruments with his left hand and projected "natural harmonics of the horn directly into the open strings of the grand piano to create resonance."[@LeftAlonePN Program note.] This early use of the horn and natural harmonics is notable considering the importance place that microtonality has taken up in the works of Abrahamsen's third period, including in *Wald*.

## Form

In an interview with the BBC prior to its UK premiere, Abrahamsen noted that *Wald* could bear the subtitle of "Variations" or "A Theme from *Walden*." The form of the work consists of an introduction and seven variations whose principle thematic material comes from the ascending perfect fourth horn segment (subset *A/a*) and the rhythmic displacement process in the first sixteen measures of *Walden*. The eight total sections can be segmented into four parts based on shared material: A, B, C, and D.

Part A consists of the Introduction, Variation 1, and Variation 2, and it takes up almost half of *Wald*'s duration. It establishes the principle compositional techniques and associative sets through these three sequences of four sections. The four sections differ in tempo, harmony, density of activity, and number of active associative sets. Like the relationship between *Walden*'s first and second movement, the four sections group into pairs where the second and fourth sections recontextualize the same associative sets from the first and third sections, respectively. Similarly, each variation within Part A re-reads the previous variation's four sections. Part B, containing Variations 3 and 4, contrasts with the first part through its quiet, introverted stasis and lack of sectional subdivisions. The two variations are bound together not only by slow tempo but also by the mysterious and winding low melody scored for cello, double bass, and timpani. Part C only includes Variation 5 but it functions as the climax, with the loudest, most chaotic, and texturally dense music. It divides into three sections; the first suddenly breaks the pensive atmosphere of Part B, while the second and third consist of a build up in energy through galloping rhythms. Finally, the last two variations of Part D combine new material alongside literal repetitions of segments from the fourth sections of Part A.

Like *Walden* and *Schnee*, which Abrahamsen also identifies as a "twin piece,"[@WaldPN Program Note] the eight sections of *Wald* decrease in duration over the course of the work. The compression of proportions at the variation-level is obscured somewhat both by the variations containing subdivisions and by the related variations forming parts. For instance, the section divisions within the variations of Part A encourage a more granular listening experience that makes perceiving the long-range compression difficult at first. These sections follow a particular ordering from longest to shortest (section 3, 2, 1, and 4), and also mirror the variation-level compression by decreasing in duration from variation to variation. But rather than pointing to any sort of deficiency in Abrahamsen's form, this multi-level proportion structure instead allows one to engage with *Wald* on the subdivision-, variation-, or part-level.

Abrahamsen juxtaposes the various subdivisions, variations, and parts with little to no transitional material. Their boundaries are clearly demarcated both sonically by abrupt changes in dynamics, timbre, texture, and register as well as visually in the score by different tempi, meters, descriptive markings, and double bar lines. Abrahamsen facilitates these abrupt juxtapositions through the use of metric modulations, which is a common characteristic of his third period style. Table @tbl:wald-form details the divisions within *Wald* by providing a comprehensive list of every tempo change and descriptive marking that accompanies a variation or subdivision. It also identifies the variations that group together as Parts (evident through explicitly returning tempo and descriptive markings) and gives the durations for individual variations (measured from the only commercially released recording by Asko|Schönberg Ensemble[@WaldRec]).
...
The musical material throughout *Wald* can be categorized into nine associative sets (see Figure @fig:wald-sets-all for prototypical segments). The sets differ in their number of subsets and segments but share many overlapping sonic and contextual criteria, which lends cohesion and economy of materials. Associative set *F* consists of a repeated simultaneity ranging from a simple dyad to a dense chord, and Abrahamsen scores it for piano, harp, marimba, or celesta. Set *G* is defined by either a polyrhythmic repeated note texture or an unmeasured tremolo which Abrahamsen places most often in the two violins of Group VI. Set *H* and *J* correspond closely with sets *A* and *B* of *Walden*, but rather than carry over the set names from *Walden*, they have been differentiated with a new letter name for the sake of clarity. Like *A* and *B*, *H* is a rising perfect fourth call and *J* is an imitative response. Abrahamsen binds them together in a displacement process during the first and second sections of Part A. Associative set *K* contains numerous agitated, pentatonic-based segments located primarily in the third sections of Part A. Set *L* consists of cascading segments that alternate between piano and a duo of harp and marimba. Abrahamsen constructs set *L* from superimpositions of set *K* segments. Set *M*, which is always paired with *L*, consists of legato, melodic segments drawn from the more harmonically complex statements of set *L*. Abrahamsen shapes the fourth sections of Part A with the two and later returns to verbatim *M* segments in Variation 6. Segments of set *N* project the slow and mysterious "Nachtmusik" melody found in Part B. The entire ensemble performs segments of set *O* only during the first two sections of Variation 5, and it is defined by large intervallic leaps, loud dynamics, and wide registral bandwidth.
