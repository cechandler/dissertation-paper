...
Part I consists of the Introduction, Variation 1, and Variation 2 and takes up almost half of *Wald*'s duration. It establishes the principle compositional techniques and associative sets through these three sequences of four sections. The four sections differ in tempo, harmony, density of activity, and number of active associative sets. Part II, containing Variations 3 and 4, contrasts with the first part through its quiet, introverted stasis and lack of sectional subdivisions. The two variations in Part II are bound together not only by slow tempo but also by the mysterious and winding low melody scored for cello, double bass, and timpani. Part III only includes Variation 5 but it functions as the climax, with the loudest, most chaotic, and texturally dense music. It divides into three sections; the first suddenly breaks the pensive atmosphere of Part II, while the second and third consist of a build up in energy through galloping rhythms. Finally, the last two variations of Part IV combine recontextualized material from the third sections of Part I along with literal repetitions of segments from the fourth sections of Part I. Table @tbl:wald-form details these formal divisions within *Wald*.

Abrahamsen juxtaposes the various subdivisions, variations, and parts with little to no transitional material. Their boundaries are clearly demarcated sonically by abrupt changes in dynamics, timbre, texture, and register as well as visually in the score by different tempi, meters, descriptive markings, and double bar lines. Abrahamsen facilitates these abrupt juxtapositions through the use of metric modulations, which is a common characteristic of his third period. Table @tbl:wald-form provides a comprehensive list of every tempo change and descriptive marking that accompanies a variation or subdivision and also identifies the variations that group together as Parts (evident through explicitly returning tempo and descriptive markings) and gives the durations for variations and their sectional subdivisions (measured from the only commercially released recording by Asko|Schönberg Ensemble[@WaldRec]).
