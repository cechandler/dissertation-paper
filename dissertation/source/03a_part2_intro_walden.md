...
The first and second movements of *Walden* are closely connected to *Wald* through common compositional techniques, associative sets, and recontextualization. While the third and fourth movement contain many interesting features, the bulk of the following analytical sections will concentrate only on the first and second movements.
