...
B/b: announcement gesture
B/c: permutational homophonic melody
B/d: polyrhythmic texture in III
-->

Associative set *B* represents the largest and most prevalent group of segments in *Walden*. It contains four associative subsets bound together by C~cseg\ <01>~, C~cseg\ <10>~, C~SC\ 3-2[013]~, and C~SC\ 3-6[024]~. Abrahamsen uses the subsets for different purposes throughout the work: *B/a* and *B/d* generate polyrhythmic, heterophonic textures, *B/b* interjects or announces important formal moments, and *B/c* projects a permutational melody. Common attributes shared by many segments of *B* subsets include: two note groupings separated by a short rest, small melodic bandwidth between a minor 2^nd^ and minor 3^rd^ (C~ic\ 1~, C~ic\ 2~, and C~ic\ 3~), and legato articulation with an occasional staccato punctuation. Subset *B/a* is found in the first and third movement, *B/b* in the second and third movement, *B/c* in the first, second, and third, and *B/d* in the first and third. Figure @fig:walden-set-b-all gives example segments from each subset.
...
The techniques Abrahamsen uses to generate the heterophonic textures of *B/a* and *B/d* include canon and rhythmic displacement. With both subsets, Abrahamsen creates organizes them in three separate layers of segments differentiated by rhythmic subdivision: one layer subdivides in eighth or sixteenth notes, one in quintuplet sixteenths, and one in triplet eighths. This organization is evident in the two canonic trios that define the second and third sections of the first movement.
