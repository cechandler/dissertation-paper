...
In Var1:Sec2, the *J/b* segment continues to serve as the central axis of displacement, but Abrahamsen varies the process by appending and prepending additional dyads to the other two chromatic strands such that both contain a sequence of C~pitch\ <`C#4`,`F#4`,`Eb4`,`Ab4`>~. As in the previous section, the quarter note strand shifts earlier while the triplet quarter note strand displaces later with each segment. Abrahamsen no longer alternates segments between the harp and marimba as in Intro:Sec1; rather, he presents two superimposed segments in both instruments where each articulates not only the central, embedded *J/b* segment but also one dyad from each rhythmic subdivision strand. Figure @fig:wald-var1-sec2-j-process illustrates this orchestration. The upper two staves display the composite simultaneous segments in the marimba and harp from mm. 173-179, while the lower staves teases out the three strands.

<!--
no longer alternates segments between the harp and marimba but instead presents two sequences of eight superimposed segments of *J/c*. One sequence is related to the four segments of Intro:Sec2 by literal repetition but continues the trajectory of rhythmically pulling apart for an additional four statements. The other sequence shares the same central *J/b* axis but differs in two aspects of organization. First, the two outer chromatic dyads exchange rhythmic subdivision; the `C#4`-`F#4` dyad moves at a triplet quarter speed and the `Eb4`-`Ab4` dyad at a quarter note speed. Second, the sequence of eight segments begins more rhythmically displaced and contracts over five segments before expanding for the last three, which are literal rhythmic repetitions of the first three segments from Intro:Sec2. These aspects can clearly be seen in Figure @fig:wald-var1-sec2-j-process; it shows the sixteen segments of *J/c* throughout Var1:Sec2 but separates them by expansion and contraction process. With both sequences the quarter note divisions shift earlier and the triplet quarter divisions shift later by one value of their subdivision with each segments.^[N.B. The second segment in the lower half of Figure @fig:wald-var1-sec2-j-process corresponds to the mm. 182-86 in the harp. In the score, measure 182 is notated incorrectly with the `C#4` falling on the second beat of the measure instead of the downbeat, but it is listed correctly in this figure.]

![Var1:Sec2 *J/d* and *J/f* rhythmic processes](/Volumes/Data/Dropbox/Composition/Current-Projects/dissertation-paper/figures/temporary.png){#fig:wald-var1-sec2-j-process}
-->

![Var1:Sec2 *J/c* rhythmic process](/Volumes/Data/Dropbox/Composition/Current-Projects/dissertation-paper/figures/temporary.png){#fig:wald-var1-sec2-j-process}
...
![Collisions between *F/a* and *J/f* in Var1:Sec2](/Volumes/Data/Dropbox/Composition/Current-Projects/dissertation-paper/figures/wald-var1-sec2-fa-jf-collisions.png){#fig:wald-var1-sec2-fa-jf-collisions}
