...
Figure @fig:wald-intro-sec2-jd-rd shows the first two segments of *J/c* in Intro:Sec2. The top stave displays the six-note segment found in the harp and marimba while the lower three staves tease out the three strands of perfect fourths, including the embedded *J/b* segment. These intertwined fourths project a composite polyrhythm of 4 against 5 against 6 (i.e. quarters vs. quintuplet eighths vs. triplet quarters) that remains consistent in duration (i.e. 3 and 2 quarters vs. 6 and 4 quintuplet eighths vs. 3 and 2 triplet quarters). Comparing the two phrases in Figure @fig:wald-intro-sec2-jd-rd highlights how the displacement process unfolds during Intro:Sec2. The *J/b* segment occupies the central position in the rhythmic sequence, mirroring its central position in the `6-6` collection and cycling every eight measures. While it always occurs on the downbeat, the `C#4`-`F#4` dyad shifts earlier and `Eb4`-`Ab4` shifts later at a rate of one quarter note and one triplet quarter, respectively, per segment.

![Intro:Sec2 *J/d* rhythmic displacement](/Volumes/Data/Dropbox/Composition/Current-Projects/dissertation-paper/figures/wald-intro-sec2-jd-rd.png){#fig:wald-intro-sec2-jd-rd}
...
![Var1:Sec2 *J/d* and *J/f* rhythmic processes](/Volumes/Data/Dropbox/Composition/Current-Projects/dissertation-paper/figures/wald-var1-sec2-set-j-process.png){#fig:wald-var1-sec2-j-process}
