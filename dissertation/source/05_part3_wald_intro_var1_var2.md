...
Like the first movement of *Walden*, the first subsection of the Introduction features four phrases where an ascending perfect fourth motive and three echoing response motives undergo rhythmic displacement. Each of the four phrases features a specific collection of instruments from Group III and Group IV (see Figure @fig:wald-seating-plan).
