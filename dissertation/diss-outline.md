...
- Connect the bolded bit above to how Abrahamsen does not re-visit the rhythmic dispalcement element at all in *Walden* yet does so for many other features.
...
- "In discussing the richly allusive poetry of Virgil's *Georgics*, R. F. Thomas distinguished six categories of allusive reference, which are applicable to a wider cultural sphere. These types are" (from Wikipedia):
